...
PROMPTS = [
    ...
    ['1girl, dynamic action pose, jumping, holding a glowing magic wand, barefoot, high quality hand, on street, masterpiece', 2],
    ['A beautiful cyberpunk city, high resolution, 8k, neon lights, highly detailed', 3],
    ['A girl sitting on a giant ice cream, which is adorned with vibrant colors, delightful frosting, and rainbow sprinkles. She holds an oversized waffle cone,shimmering candies. Floating around her are some small balloons, each tied to a petite candy. The scene is filled with sweetness and joy, showcasing the girls happiness and the enchanting fusion of her imagination and a fantastical world,fantasy, high contrast, ink strokes, explosions, over exposure, purple and red tone impression , abstract, ((watercolor painting by John Berkey and Jeremy Mann )) brush strokes, negative space,', 4],
