...
# Original source: https://github.com/huggingface/diffusers/tree/main/src/diffusers/schedulers/scheduling_dpmsolver_multistep.py

### patch ###
import numpy as torch
from .scheduling_base import SchedulerMixin, ConfigMixin, register_to_config
from .torch_numpyize import SchedulerOutput, KarrasDiffusionSchedulers, randn_tensor
...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(
        ...
        if timesteps is not None:
            ...
            last_timestep = ((self.config.num_train_timesteps - clipped_idx)).item()
        ...
        self.timesteps = torch.from_numpy(timesteps).astype(torch.int64)
    ...
    def step(
        ...
        if self.config.algorithm_type in ["sde-dpmsolver", "sde-dpmsolver++"] and variance_noise is None:
            ...
            noise = variance_noise.astype(torch.float32)
        else:
            noise = None
