...
# Original source: https://github.com/huggingface/diffusers/tree/main/src/diffusers/schedulers/scheduling_ddim.py
...
class DDIMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def add_noise(
        ...
        alphas_cumprod = self.alphas_cumprod.astype(dtype=original_samples.dtype)
    ...
    def get_velocity(self, sample: torch.Tensor, noise: torch.Tensor, timesteps: torch.IntTensor) -> torch.Tensor:
        ...
        alphas_cumprod = self.alphas_cumprod.astype(dtype=sample.dtype)
