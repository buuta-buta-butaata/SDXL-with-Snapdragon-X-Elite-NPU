...
# Original source: https://github.com/huggingface/diffusers/tree/main/src/diffusers/schedulers/scheduling_dpmsolver_singlestep.py
...
class DPMSolverSinglestepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(
        ...
        self.timesteps = torch.from_numpy(timesteps).astype(dtype=torch.int64)
